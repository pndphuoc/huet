    ...
    return ShowUp(
      ...
      child: Container(
        ...
        child: Center(
          child: Column(
            children: [
              Text("Homestays", style: GoogleFonts.poppins(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.black), textAlign: TextAlign.center,),
              Text("Best-rated homestays in the last month", style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w300), textAlign: TextAlign.center),
            ],
          ),
        ),
      ),
